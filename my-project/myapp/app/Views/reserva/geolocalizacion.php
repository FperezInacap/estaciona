...
<html lang="en">
  ...
  <body>
    Estaciona<!-- Defined commutes SVGs -->
    <svg class="hide">
      <defs>
    ...
    <script>
      const CONFIGURATION = {
        ...
        "isMetric": false,
        "mapOptions": {"center":{"lat":-33.4053255,"lng":-70.6826535},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":14,"zoomControl":true,"maxZoom":20},
        "mapsApiKey": "AIzaSyCWi0r7l59CJFCrWJwvGEI6M19bzVKvFXM"
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWi0r7l59CJFCrWJwvGEI6M19bzVKvFXM&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v1_c" async defer></script>
  </body>
</html>