...
<html lang="en">
  ...
  <body>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAw6WsNzg_29tKLgEulinYe-16IJ2dI2K0&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v1_c" async defer></script>
  </body>
</html>
<?= $this->endSection() ?>
</body>
